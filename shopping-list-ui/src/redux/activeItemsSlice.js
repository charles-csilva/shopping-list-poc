...
export const activeItemCreateAction = payload => ({
	type: activeItemCreateActionType,
	payload,
});

export const activeItemDeleteActionType = 'activeItems/delete';
export const activeItemDeleteAction = payload => ({
	type: activeItemDeleteActionType,
	payload,
});

export const activeItemMarkAsCompleteActionType = 'activeItems/markComplete';
export const activeItemMarkAsCompleteAction = payload => ({
	type: activeItemMarkAsCompleteActionType,
	payload,
});

export const activeItemsChangedActionType = 'activeItems/changed';
export const activeItemsChangedAction = () => ({
	type: activeItemsChangedActionType,
});
